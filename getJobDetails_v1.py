...
def prepare_summary():
    ...
    today_db_query = """
        ...
        GROUP BY bji.job_name, be.status;
    """
    db_today_details = fetch_db_details(today_db_query)git 
...
if __name__ == "__main__":
    # Global variables for database and file paths
    global spath, spath2, dbname, username, pwd, hostname, portnumber

    spath = "/Users/batch.csv"
    spath2 = "/Users/batchAMJobs.csv"
    dbname = "xxxx"
    username = "xxxx"
    pwd = "xxxx"
    hostname = "xxxx"
